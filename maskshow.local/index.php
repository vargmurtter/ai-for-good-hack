...
<div id="header-featured">
	<div id="banner-wrapper">
		<div id="banner" class="container">
			<h2>Маски</h2>
			<p><strong>Mask Show</strong> - сервис, предостовляющий разработчикам возможность интегрировать распознование медицинских масок в их продукты. </p>
			<a href="#login" class="button">НАЧАТЬ</a>
		</div>
	</div>
</div>
<div id="wrapper">
	...
	<div id="featured-wrapper">
		<div id="featured" class="extra2 margin-btm container">
			<div class="main-title">
				<h2>Регистрация</h2>
				<span class="byline">Войдите или зарегистрируйтесь</span>
			</div>
			...
			<div>
				<form method="POST" action="reg.php">
					...
					<input class="vm-field" type="password" name="repeat_password" placeholder="Repeat Password" /><br />
					<input class="button vm-button" type="submit" name="submit" value="Регистрация" />
